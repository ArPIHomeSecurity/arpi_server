...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "arm_state",
            sa.Enum("AWAY", "STAY", "MIXED", "DISARM", name="armstates"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "trigger_type",
            sa.Enum("area", "system", "button", name="output_trigger_type"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
            "type", sa.Enum("AWAY", "STAY", "MIXED", "DISARM", name="armstates"), nullable=False
        ),
