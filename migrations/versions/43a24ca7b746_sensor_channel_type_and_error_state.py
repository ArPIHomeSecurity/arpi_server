...
channel_types = sa.Enum('normal', 'channel_a', 'channel_b', name='channel_types')
...
def upgrade():
    ...
    with op.batch_alter_table('sensor', schema=None) as batch_op:
        batch_op.add_column(sa.Column('channel_type', channel_types, nullable=False, server_default='normal'))
        batch_op.add_column(sa.Column('error', sa.Boolean(), nullable=False, server_default=sa.sql.expression.false()))
