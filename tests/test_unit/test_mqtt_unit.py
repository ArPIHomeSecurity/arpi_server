...
def test_parse_output_command_topic():
    assert parse_output_command_topic("arpi/switch/siren_1/state/set") == ("siren", 1)
    assert parse_output_command_topic("arpi/switch/relay_output_5/state/set") == ("relay_output", 5)
    assert parse_output_command_topic("arpi/switch/siren/state/set") == (None, None)
    assert parse_output_command_topic("arpi/switch/siren_abc/state/set") == (None, None)
