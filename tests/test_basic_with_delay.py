...
def test_arm_away(database_data, monitor, server, device_token, user_token):
...
@pytest.mark.parametrize("database_data", [create_test_with_delay_v2], indirect=True)
def test_arm_stay(database_data, monitor, server, device_token, user_token):
    """
...
@pytest.mark.parametrize("database_data", [create_test_with_delay_v2], indirect=True)
def test_alert(database_data, monitor, server, device_token, user_token):
    monitor_events = MonitorEventsClient(device_token)
    ...
    try:
        ...
        difference = DeepDiff(
                        ...
                        "sensors": [
                            {
                                ...
                                "sensorId": 1,
                                "silent": True,
                                "startTime": "2026-05-08 22:02:53",
                                "typeId": 1,
                            }
                        ],
                        "silent": False,
                        "startTime": "2026-05-08 20:02:56",
                    },
                    "arm": {
                        "keypadId": None,
                        "time": "2026-05-08 22:02:53",
                        "type": "arm_away",
                        "userId": 1,
                    },
                    "disarm": {"keypadId": None, "time": "2026-05-08 22:02:56", "userId": 1},
                    "sensorChanges": [
                        {
                            "sensors": [
                                {
            ...
            exclude_paths=[
                ...
                "root[0]['alert']['endTime']",
                "root[0]['alert']['sensors'][0]['startTime']",
                "root[0]['alert']['sensors'][0]['endTime']",
                ...
                "root[0]['sensorChanges'][0]['sensors'][3]['timestamp']",
            ],
        )
