...
def test_01_arm_away(device_token, user_token):
    ...
    try:
        ...
        append_sms_message("+1234567890", "1234 away", time=datetime.now().astimezone())
        ...
        monitor_events.wait_for_events(
            ...
            timeout=3,  # it takes some time for the system process an SMS command
        )
        ...
        # disarm the system
        append_sms_message("+1234567890", "1234 disarm", time=datetime.now().astimezone())
